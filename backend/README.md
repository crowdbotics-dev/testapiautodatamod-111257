...
## Project Structure
    ...
    ├── testapiautodatamod_111257  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_111257`
...
2. Clone this repo and `cd testapiautodatamod_111257`
